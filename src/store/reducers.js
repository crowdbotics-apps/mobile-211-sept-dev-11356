...
export default function apiReducer(state = initialState, action) {
  switch (action.type) {
    ...
    case types.API_V1_HHJGJFJG_LIST:
    case types.API_V1_HHJGJFJG_LIST_SUCCEEDED:
    case types.API_V1_HHJGJFJG_LIST_FAILED:
    case types.API_V1_HHJGJFJG_CREATE:
    case types.API_V1_HHJGJFJG_CREATE_SUCCEEDED:
    case types.API_V1_HHJGJFJG_CREATE_FAILED:
    case types.API_V1_HHJGJFJG_READ:
    case types.API_V1_HHJGJFJG_READ_SUCCEEDED:
    case types.API_V1_HHJGJFJG_READ_FAILED:
    case types.API_V1_HHJGJFJG_UPDATE:
    case types.API_V1_HHJGJFJG_UPDATE_SUCCEEDED:
    case types.API_V1_HHJGJFJG_UPDATE_FAILED:
    case types.API_V1_HHJGJFJG_PARTIAL_UPDATE:
    case types.API_V1_HHJGJFJG_PARTIAL_UPDATE_SUCCEEDED:
    case types.API_V1_HHJGJFJG_PARTIAL_UPDATE_FAILED:
    case types.API_V1_HHJGJFJG_DELETE:
    case types.API_V1_HHJGJFJG_DELETE_SUCCEEDED:
    case types.API_V1_HHJGJFJG_DELETE_FAILED:
