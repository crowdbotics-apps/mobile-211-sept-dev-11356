...
export const api_v1_hhjgjfjg_list = () => ({ type: types.API_V1_HHJGJFJG_LIST })
export const api_v1_hhjgjfjg_listSucceeded = response => ({
  type: types.API_V1_HHJGJFJG_LIST_SUCCEEDED,
  response
})

export const api_v1_hhjgjfjg_listFailed = error => ({
  type: types.API_V1_HHJGJFJG_LIST_FAILED,
  error
})

export const api_v1_hhjgjfjg_create = () => ({
  type: types.API_V1_HHJGJFJG_CREATE
})

export const api_v1_hhjgjfjg_createSucceeded = response => ({
  type: types.API_V1_HHJGJFJG_CREATE_SUCCEEDED,
  response
})

export const api_v1_hhjgjfjg_createFailed = error => ({
  type: types.API_V1_HHJGJFJG_CREATE_FAILED,
  error
})

export const api_v1_hhjgjfjg_read = () => ({ type: types.API_V1_HHJGJFJG_READ })
export const api_v1_hhjgjfjg_readSucceeded = response => ({
  type: types.API_V1_HHJGJFJG_READ_SUCCEEDED,
  response
})

export const api_v1_hhjgjfjg_readFailed = error => ({
  type: types.API_V1_HHJGJFJG_READ_FAILED,
  error
})

export const api_v1_hhjgjfjg_update = () => ({
  type: types.API_V1_HHJGJFJG_UPDATE
})

export const api_v1_hhjgjfjg_updateSucceeded = response => ({
  type: types.API_V1_HHJGJFJG_UPDATE_SUCCEEDED,
  response
})

export const api_v1_hhjgjfjg_updateFailed = error => ({
  type: types.API_V1_HHJGJFJG_UPDATE_FAILED,
  error
})

export const api_v1_hhjgjfjg_partial_update = () => ({
  type: types.API_V1_HHJGJFJG_PARTIAL_UPDATE
})

export const api_v1_hhjgjfjg_partial_updateSucceeded = response => ({
  type: types.API_V1_HHJGJFJG_PARTIAL_UPDATE_SUCCEEDED,
  response
})

export const api_v1_hhjgjfjg_partial_updateFailed = error => ({
  type: types.API_V1_HHJGJFJG_PARTIAL_UPDATE_FAILED,
  error
})

export const api_v1_hhjgjfjg_delete = () => ({
  type: types.API_V1_HHJGJFJG_DELETE
})

export const api_v1_hhjgjfjg_deleteSucceeded = response => ({
  type: types.API_V1_HHJGJFJG_DELETE_SUCCEEDED,
  response
})

export const api_v1_hhjgjfjg_deleteFailed = error => ({
  type: types.API_V1_HHJGJFJG_DELETE_FAILED,
  error
})
