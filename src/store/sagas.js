...
function* api_v1_hhjgjfjg_listWorker(action) {
  try {
    const result = yield call(apiService.api_v1_hhjgjfjg_list, action)
    yield put(actions.api_v1_hhjgjfjg_listSucceeded(result))
  } catch (err) {
    yield put(actions.api_v1_hhjgjfjg_listFailed(err))
  }
}
function* api_v1_hhjgjfjg_listWatcher() {
  yield takeEvery(types.API_V1_HHJGJFJG_LIST, api_v1_hhjgjfjg_listWorker)
}
function* api_v1_hhjgjfjg_createWorker(action) {
  try {
    const result = yield call(apiService.api_v1_hhjgjfjg_create, action)
    yield put(actions.api_v1_hhjgjfjg_createSucceeded(result))
  } catch (err) {
    yield put(actions.api_v1_hhjgjfjg_createFailed(err))
  }
}
function* api_v1_hhjgjfjg_createWatcher() {
  yield takeEvery(types.API_V1_HHJGJFJG_CREATE, api_v1_hhjgjfjg_createWorker)
}
function* api_v1_hhjgjfjg_readWorker(action) {
  try {
    const result = yield call(apiService.api_v1_hhjgjfjg_read, action)
    yield put(actions.api_v1_hhjgjfjg_readSucceeded(result))
  } catch (err) {
    yield put(actions.api_v1_hhjgjfjg_readFailed(err))
  }
}
function* api_v1_hhjgjfjg_readWatcher() {
  yield takeEvery(types.API_V1_HHJGJFJG_READ, api_v1_hhjgjfjg_readWorker)
}
function* api_v1_hhjgjfjg_updateWorker(action) {
  try {
    const result = yield call(apiService.api_v1_hhjgjfjg_update, action)
    yield put(actions.api_v1_hhjgjfjg_updateSucceeded(result))
  } catch (err) {
    yield put(actions.api_v1_hhjgjfjg_updateFailed(err))
  }
}
function* api_v1_hhjgjfjg_updateWatcher() {
  yield takeEvery(types.API_V1_HHJGJFJG_UPDATE, api_v1_hhjgjfjg_updateWorker)
}
function* api_v1_hhjgjfjg_partial_updateWorker(action) {
  try {
    const result = yield call(apiService.api_v1_hhjgjfjg_partial_update, action)
    yield put(actions.api_v1_hhjgjfjg_partial_updateSucceeded(result))
  } catch (err) {
    yield put(actions.api_v1_hhjgjfjg_partial_updateFailed(err))
  }
}
function* api_v1_hhjgjfjg_partial_updateWatcher() {
  yield takeEvery(
    types.API_V1_HHJGJFJG_PARTIAL_UPDATE,
    api_v1_hhjgjfjg_partial_updateWorker
  )
}
function* api_v1_hhjgjfjg_deleteWorker(action) {
  try {
    const result = yield call(apiService.api_v1_hhjgjfjg_delete, action)
    yield put(actions.api_v1_hhjgjfjg_deleteSucceeded(result))
  } catch (err) {
    yield put(actions.api_v1_hhjgjfjg_deleteFailed(err))
  }
}
function* api_v1_hhjgjfjg_deleteWatcher() {
  yield takeEvery(types.API_V1_HHJGJFJG_DELETE, api_v1_hhjgjfjg_deleteWorker)
}
...
export default function* rootSaga() {
  const sagas = [
    ...
    api_v1_hhjgjfjg_listWatcher,
    api_v1_hhjgjfjg_createWatcher,
    api_v1_hhjgjfjg_readWatcher,
    api_v1_hhjgjfjg_updateWatcher,
    api_v1_hhjgjfjg_partial_updateWatcher,
    api_v1_hhjgjfjg_deleteWatcher,
